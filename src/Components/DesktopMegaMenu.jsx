...
//         {/* LEFT COLUMN: Main Categories (Slightly off-white background based on typical P&Co styling) */}
...
//                   onMouseEnter={() => setActiveHoverItem(cat)}
...
//                   >
//                     {cat.label}
//                     {/* Show arrow if it has sublinks AND is currently active */}
...
//         {/* RIGHT COLUMN: Dynamic Content (Sublinks OR Showcase Image) */}
...
//                     <a 
//                       href={sub.href} 
//                       className="font-central text-[11px] font-bold uppercase tracking-[0.2em] text-nav-dark hover:text-[#a58c69] transition-colors"
//                     >
//                       {sub.label}
//                     </a>
//                   </li>
